...
//Wenn ein Button gedrückt wird soll der Motor gestoppt werden
  ...
  if (newRfid.equals(SouthernComfortRFID) && SouthernComfortMAß != 0)
  {
  ...
  if (newRfid.equals(MaracujasirupRFID) && MaracujasirupMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    MaracujasirupMAß -= 1;
  ...
  if (newRfid.equals(GingeraleRFID) && GingeraleMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    GingeraleMAß -= 1;
  ...
  if (newRfid.equals(WodkaRFID) && WodkaMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    WodkaMAß -= 1;
  ...
  if (newRfid.equals(SahneRFID) && SahneMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    SahneMAß -= 1;
  ...
  if (newRfid.equals(BlueCuracaoRFID) && BlueCuracaoMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    BlueCuracaoMAß -= 1;
  ...
  if (newRfid.equals(KokossirupRFID) && KokossirupMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    KokossirupMAß -= 1;
  ...
  if (newRfid.equals(RumRFID) && RumMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    RumMAß -= 1;
  ...
  if (newRfid.equals(AnanassaftRFID) && AnanassaftMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    AnanassaftMAß -= 1;
  ...
  if (newRfid.equals(MandelsirupRFID) && MandelsirupMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    MandelsirupMAß -= 1;
  ...
  if (newRfid.equals(ZuckersirupRFID) && ZuckersirupMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    ZuckersirupMAß -= 1;
  ...
  if (newRfid.equals(OrangensaftRFID) && OrangensaftMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    OrangensaftMAß -= 1;
  ...
  if (newRfid.equals(KaffeelikoerRFID) && KaffeelikoerMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    KaffeelikoerMAß -= 1;
  ...
  if (newRfid.equals(TomatensaftRFID) && TomatensaftMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    TomatensaftMAß -= 1;
  ...
  if (newRfid.equals(LimettensaftRFID) && LimettensaftMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    LimettensaftMAß -= 1;
  ...
  if (newRfid.equals(CointreuRFID) && CointreuMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    CointreuMAß -= 1;
  ...
  if (newRfid.equals(CranberrynektarRFID) && CranberrynektarMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
  ...
  if (newRfid.equals(GrenadineRFID) && GrenadineMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    GrenadineMAß -= 1;
  ...
  if (newRfid.equals(PfirsichlikoerRFID) && PfirsichlikoerMAß != 0)
  {
    servoMotor.write(hoch);
    delay (30);
    PfirsichlikoerMAß -= 1;
  ...
  if (newRfid.equals(PfirsichlikoerRFID))
  {
    Pfirsichlikoer = true;
  }
